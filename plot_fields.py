...
def plot_field_data(mode):
    ...
    axes[0,0].set_title(f'Campos Eléctricos - Modo {mode}')
    axes[0,0].set_xlabel('Posición (m)')
    axes[0,0].set_ylabel('Campo (V/m)')
    axes[0,0].legend()
    axes[0,0].grid(True)
    ...
    axes[0,1].set_title(f'Campos Magnéticos - Modo {mode}')
    axes[0,1].set_xlabel('Posición (m)')
    axes[0,1].set_ylabel('Campo (T)')
    axes[0,1].legend()
    axes[0,1].grid(True)
    ...
    axes[1,0].set_xlabel('Posición (m)')
    axes[1,0].set_ylabel('Corriente (A/m²)')
    axes[1,0].legend()
    axes[1,0].grid(True)
    ...
    if mode in ['R', 'L']:
        ...
        axes[1,1].set_title(f'Diagrama de Fases Ex-Ey - Modo {mode}')
